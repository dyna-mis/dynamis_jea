		...
		do
                if [[ $file == *10000 ]];
                        ...
                        for a in "${algoR[@]}";
                                ...
                                for m in "${mod[@]}";
                                        do
                                        	qsub -N "${a}_${m}_${file##*/}" -l bc4 -l h_rt=00:30:00 -r y ./dynamis_1_rectangle.sh $file $a $m 0.04 ./OUTPUT/E1_Rect
                                        done
                                done
                	fi
		done
...
for file in INPUT/rectangle/sin1000/*;
                ...
                if [[ $file == * ]];
                        ...
                        for a in "${algoRE[@]}";
                                ...
                                for m in "${mod[@]}";
                                        do
                                        qsub -N "${a}_${m}_${file##*/}" -l bc4 -l h_rt=00:30:00 -r y ./dynamis_1_rectangle.sh $file $a $m 0.1 ./OUTPUT/E4_Rect
                                        done
                                done
                        fi
                done
        ...
        for file in $problem/*;
                do
                        for a in "${algoR[@]}";
                                ...
                                for m in "${mod[@]}";
                                        do
						qsub -N "${a}_${m}_${file##*/}" -l bc4 -l h_rt=00:30:00 -r y ./dynamis_1_rectangle_recompute.sh $file $a $m 0.1 ./OUTPUT/E5_Rect
                                        	qsub -N "${a}_${m}_${file##*/}" -l bc4 -l h_rt=00:30:00 -r y ./dynamis_1_rectangle.sh $file $a $m 0.1 ./OUTPUT/E5_Rect
                                        done
                                done
                done
